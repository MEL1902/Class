...
public class Client {
    public int someMethod(CalculateCommand calculateCommand) {
        ...
        //early return은 핵심 로직 수행 전에 아예 리턴구문과 함꼐 앞쪽에 검사로직을 배치하는것입니다.
        //return이 실행되는 순간 메서드는 그대로 종료되기 때문에 핵심 로직을 불완전한 상태로 수행하지 않습니다.
        if (calculateType == null) {
            return result;
        }

        //num2가 0인지 아닌지 여부만 확인하면, 더하기 빼기 곱하기 등 0이어도 상광없는 연산까지 막으므로
